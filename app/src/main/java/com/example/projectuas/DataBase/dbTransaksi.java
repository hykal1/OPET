...
public class dbTransaksi extends SQLiteOpenHelper {
    ...
    public static final String CREATE_LAYANAN = "CREATE TABLE "+ TABLE_TRANSAKSI + "(Id INTEGER PRIMARY KEY AUTOINCREMENT, " + "Id_vet INTEGER, Id_user INTEGER, Jenis_layanan TEXT, biaya INTEGER, bulan INTEGER, tahun INTEGER);";
    public static final String CREATE_LAYANAN2 = "CREATE TABLE "+ TABLE_TRANSAKSI2 + "(Id INTEGER PRIMARY KEY AUTOINCREMENT, " + "Id_groom INTEGER, Id_user INTEGER, Jenis_layanan TEXT, biaya INTEGER, bulan INTEGER, tahun INTEGER);";
